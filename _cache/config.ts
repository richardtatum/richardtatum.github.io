...
export default {
  global: {
     ...
     */
    opg: {
      'profile:first_name': 'Richard',
      'profile:gender': 'male',
      'profile:last_name': 'Tatum',
    },
  ...
  data: {
     ...
     */
    socialMedia: [
      { name: 'Github', icon: 'github', link: 'https://github.com/richardtatum' },
      { name: 'LinkedIn', icon: 'linkedin', link: 'https://www.linkedin.com/in/richard-tatum-52a52959/' },
    ],
  },
  ...
  templates: {
    default: {
       ...
       */
      background: 'https://images.unsplash.com/photo-1460186136353-977e9d6085a1',
